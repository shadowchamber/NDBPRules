...
{
    [DataContract]
    public class TableConfigurationKeyMissing : CustomDiagnosticItem
    {
        public const string DiagnosticMoniker = "NDTableConfigurationKeyMissing";

        public TableConfigurationKeyMissing(
            string path,
            string elementType,
            TextPosition textPosition,
            string invalidChars)
            : base(path, elementType, textPosition, DiagnosticType.BestPractices, Severity.Warning, DiagnosticMoniker, Messages.TableConfigurationKeyMissing, invalidChars)
        {

        }

        public TableConfigurationKeyMissing(XElement element)
            : base(element)
        {
        }

...
{
    [DataContract]
    public class TableCacheLookupMissing : CustomDiagnosticItem
    {
        public const string DiagnosticMoniker = "NDTableCacheLookupMissing";

        public TableCacheLookupMissing(
            string path,
            string elementType,
        ...
        public TableCacheLookupMissing(XElement element)
            : base(element)
        {
        }
